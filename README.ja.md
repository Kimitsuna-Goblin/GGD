...
これは **Gradational Gaussian Distribution (GGD; グラデーションガウス分布)**
...
左右に歪んだ分布、裾の重い分布、頂点が扁平な分布などを表すことができます。
...
今度は確率密度関数が $\mathcal{N}_1$ とは異なる $\mathcal{N}_3$ のものに変化していくような、歪んだ分布モデルを考えることができます。
