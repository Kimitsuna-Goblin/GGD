...
X軸方向やY軸方向に沿って、グラデーション的に、徐々に正規分布の混合比率を変化させた分布モデルです。
...
2. 横方向 (X軸方向) に2つの正規分布の混合比率が漸次的に変化する分布 (横方向漸変分布; Horizontal Gradational Distribution)
3. 縦方向 (Y軸方向) に2つまたは3つの正規分布の混合比率が漸次的に変化する分布 (縦方向漸変分布; Vertical Gradational Distribution)
4. 縦横 (X軸、Y軸) 両方向に4つの正規分布の混合比率が漸次的に変化する分布 (縦横漸変分布; Vertical-Horizontal Gradational Distribution)
...
ただし、この縦方向漸変分布は、等間隔の四分位点のトレースには、あまり適しません。
